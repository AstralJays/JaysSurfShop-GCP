...
const BASE = {
  ...
  attack_surface: {
    public: [
      ...
      { path: "/api/auth/forge", note: "Workshop: forge session cookie without password" },
      { path: "/api/exports/customer", note: "Public customer export (GCS / local)" },
    ...
    private: [
      ...
      { path: "chat-rag:8001/chat", note: "Maya RAG + Vertex tools" },
      { path: "chat-rag:8001/auth/*", note: "Login / demo accounts" },
      { path: "chat-rag:8001/orders/mine", note: "Customer orders" },
      { path: "chat-rag:8001/demo/exploit/*", note: "Exploit lab" },
      { path: "chat-rag:8001/reindex", note: "Unauthenticated admin (local compose)" },
      { path: "board-generator:8002/generate", note: "OpenAI images (optional Vertex Imagen)" },
    ],
