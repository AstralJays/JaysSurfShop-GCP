...
export default async function StaffLoginPage({
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      <p className="text-xs uppercase tracking-widest text-ocean-500 mb-2">Staff</p>
      ...
      <p className="mt-3 text-ocean-700 text-sm leading-relaxed">
        Sign in to open the ops console at <code className="bg-ocean-50 px-1 rounded">/admin</code>.
      </p>
